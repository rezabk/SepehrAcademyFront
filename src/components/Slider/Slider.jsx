        ...
        <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner" >
                <div className="carousel-item active " data-bs-interval="10000">
                    <img src={'https://sepehracademy-storage.storage.iran.liara.space/Slider/3.jpg'} className="d-block w-100" alt="..." />
                ...
                <div className="carousel-item " data-bs-interval="10000">
                    <img src={'https://sepehracademy-storage.storage.iran.liara.space/Slider/2.jpg'} className="d-block w-100" alt="..." />
                    <div className="carousel-caption d-none d-md-block">
                        <h5 className="title justify-content-center">آموزشگاه سپهر</h5>
                ...
                <div className="carousel-item " data-bs-interval="10000">
                    <img src={'https://sepehracademy-storage.storage.iran.liara.space/Slider/1.jpg'} className="d-block w-100" alt="..." />
                    <div className="carousel-caption d-none d-md-block">
                        <h5 className="title justify-content-center">آموزشگاه سپهر</h5>
